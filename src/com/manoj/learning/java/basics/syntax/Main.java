...
public class Main {
	...
	public static void main(String[] args) {
		...
		int intDatatype = 123;
		float floatDataType = 12.45f; // fractional numbers from 3.4e−038 to 3.4e+038. Note that you should end the
										// value with an "f":
		double doubleDatatype = 12.5445d;// store fractional numbers from 1.7e−308 to 1.7e+308. Note that you should end
											// the value with a "d"
