...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    /* Reason I am assigning this to boolean variable is,
	    ...
	    //Logical Operators
	    boolean logical = (x < 5 &&  x < 10); //AND statement. Returns true if both statements are true. else returns false
	    logical = (x < 5 || x < 4); // OR statement. Returns true if one of the statements are true. else returns false
